...
export default function HideUnhideContainer() {
  ...
  const tabs = [
    { id: 'hide', label: t.hide, icon: EyeOff, roles: ["Technical Back Office", "Manager", "Super Visor", "Restaurants"] },
    { id: 'unhide', label: t.unhide, icon: RefreshCw, roles: ["Technical Back Office", "Manager", "Call Center", "Super Visor", "Restaurants"] },
    { id: 'history', label: t.history, icon: History, roles: ["Technical Back Office", "Manager", "Call Center", "Super Visor", "Restaurants"] },
    { id: 'requests', label: t.requests, icon: Inbox, roles: ["Technical Back Office", "Manager", "Super Visor", "Restaurants"] },
